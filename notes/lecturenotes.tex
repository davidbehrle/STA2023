...
\begin{center}
    \begin{tikzpicture}[scale=1]
        \begin{axis}[
            ...
            \node[below] at (axis cs:0.75, 0) {-3};
            \node[below] at (axis cs:1.5, 0) {-2}; 
            \node[below] at (axis cs:2.25, 0) {-1}; 
            \node[below] at (axis cs:3, 0) {0}; 
            \node[below] at (axis cs:3.75, 0) {1};
            \node[below] at (axis cs:4.5, 0) {2};
            \node[below] at (axis cs:5.25, 0) {3};
...
\begin{shaded}
    \underline{\bf{Example:} Gettysburg Address}
    \vspace{2mm}\\
    The words of Abraham Lincoln's Gettysburg Address have an average length of 4.3 letters and a standard deviation of 2.1 letters. Random samples of 30 words are drawn from this population, and the mean of each sample is determined. Find the mean and standard deviation of the sampling distribution of sampling means. Round to one decimal place. Then sketch a graph of the sampling distribution
    \vspace{1mm}\\
    Population: $\mu = 4.3,\ \sigma = 2.1$\\
    Sampling distribution $\mu_{\bar{x}} = \mu = 4.3,\ \sigma_{\bar{x}} = \sfrac{\sigma}{\sqrt{n}} = \sfrac{2.1}{\sqrt{30}} \approx 0.4$
    ...
    \begin{center}
        \begin{tikzpicture}[scale=1]
            \begin{axis}[
                ...
                \draw [black] (axis cs:2.25,0) -- (axis cs:2.25,\valueC)
                    (axis cs:3.75,0) -- (axis cs:3.75,\valueC);
                \draw [black] (axis cs:3,0) -- (axis cs:3,\valueM);
                
                \node[below] at (axis cs:0.25, 0) {$\boldsymbol{\bar{x}:}$};
                \node[below] at (axis cs:0.75, 0) {3.1};
                \node[below] at (axis cs:1.5, 0) {3.5}; 
                \node[below] at (axis cs:2.25, 0) {3.9}; 
                \node[below] at (axis cs:3, 0) {4.3}; 
                \node[below] at (axis cs:3.75, 0) {4.7};
                \node[below] at (axis cs:4.5, 0) {5.1};
                \node[below] at (axis cs:5.25, 0) {5.5};

                \node[below] at (axis cs:0.25, -0.05) {$\boldsymbol{z:}$};
                \node[below] at (axis cs:0.75, -0.05) {-3};
                \node[below] at (axis cs:1.5, -0.05) {-2}; 
                \node[below] at (axis cs:2.25, -0.05) {-1}; 
                \node[below] at (axis cs:3, -0.05) {0}; 
                \node[below] at (axis cs:3.75, -0.05) {1};
                \node[below] at (axis cs:4.5, -0.05) {2};
                \node[below] at (axis cs:5.25, -0.05) {3};
        ...
        \end{tikzpicture}
    \end{center}
    From the central limit theorem, because the sample size is at least 30, the sampling distribution can be approximated by a normal distribution with a mean of 4.3 letters and a standard deviation of 0.4 letters
\end{shaded}
...
\begin{align}
    z = \frac{\text{value - mean}}{standard error} = \frac{\bar{x} - \mu_{\bar{x}}}{\sigma_{\bar{x}}} = \frac{\bar{x} - \mu}{\sfrac{\sigma}{\sqrt{n}}}
\end{align}
\begin{shaded}
